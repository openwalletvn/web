              ...
              >
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1 mt-1">
                    <Badge variant="secondary" className="text-sm capitalize bg-brand-blue/10 text-brand-blue border-transparent">{card.card_network}</Badge>
                    {card.card_type.map((t) => (
                      <Badge key={t} variant="outline" className="text-sm capitalize">{t}</Badge>
                    ))}
                  </div>
                  {card.co_brand && (
                    <p className="text-sm text-slate-400 mt-1">× {card.co_brand}</p>
                  )}
                </div>
              </Link>
            </div>
