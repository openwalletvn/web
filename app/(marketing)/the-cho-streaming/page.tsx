...
const TITLE = 'Thẻ Cho Streaming';
const DESCRIPTION = 'Tổng hợp thẻ tín dụng và ghi nợ phù hợp để thanh toán các dịch vụ streaming như Netflix, Spotify';
const URL = '/the-cho-streaming';
...
export default async function StreamingCardsPage() {
