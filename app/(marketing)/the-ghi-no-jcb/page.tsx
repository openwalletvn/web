...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: t('debit_jcb_title'),
    description: t('debit_jcb_description'),
    openGraph: {
      title: t('debit_jcb_title'),
      description: t('debit_jcb_description'),
    },
...
export default async function DebitJcbPage() {
  ...
  const filteredCards = allCards.filter((c) =>
    c.card_type.includes('debit') && c.card_network === 'jcb'
  );
  ...
  return (
    <div className="px-4 py-12">
      <div className="max-w-container mx-auto">
        ...
        <h1 className="text-4xl font-bold text-slate-900 mb-2">{t('debit_jcb')}</h1>
