...
export default function Page() {
    ...
    return (
        <>
            ...
            />
            <ProsePageShell title="Điều khoản sử dụng" subtitle="Cập nhật lần cuối: 7 tháng 6, 2026">
                <div className="flex flex-col gap-10">
                    ...
                    <Section title="2. Mô tả dịch vụ">
                        ...
                        <ul>
                            ...
                            <li><strong><Link href="/mcp" className="text-link">OpenWallet MCP:</Link></strong> kết nối dữ liệu thẻ OpenWallet với AI chatbot qua Model Context Protocol.</li>
                        </ul>
