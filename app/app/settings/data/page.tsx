...
export default function DataSettingsPage() {
  ...
  return (
    <>
      ...
      {/* Import */}
      <section>
        <h2 className="font-semibold text-slate-500 uppercase tracking-wider mb-1">Nhập dữ liệu</h2>
      ...
      {/* Danger zone */}
      <section>
        <h2 className="font-semibold text-red-500 uppercase tracking-wider mb-1">Vùng nguy hiểm</h2>
