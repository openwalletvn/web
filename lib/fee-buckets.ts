export const FEE_BUCKETS = [
  { value: 'under_200k', min: 0,       max: 200000,  label: 'Dưới 200.000đ',   labelEn: 'Under 200,000đ' },
  { value: 'under_500k', min: 0,       max: 500000,  label: 'Dưới 500.000đ',   labelEn: 'Under 500,000đ' },
  { value: 'under_2tr',  min: 0,       max: 2000000, label: 'Dưới 2.000.000đ', labelEn: 'Under 2,000,000đ' },
