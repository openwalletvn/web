      ...
      {bankIds.map((bankId) => {
        ...
        return (
          <button
            ...
            className={cn('flex flex-col items-center gap-1 p-2.5 border border-dashed rounded shrink-0 w-20 transition-colors', isSelected ? 'border-brand-blue bg-blue-50/60' : 'border-slate-200 hover:border-slate-300 hover:bg-slate-50/60')}
          >
            <img
