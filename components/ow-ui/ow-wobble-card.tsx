...
const WobbleCard = ({
    ...
    return (
        <motion.section
            ...
            className={cn("mx-auto w-full bg-indigo-800 relative ow-rounded-small overflow-hidden", containerClassName)}
        >
            <div
                className="relative h-full [background-image:radial-gradient(88%_100%_at_top,rgba(255,255,255,0.5),rgba(255,255,255,0))] sm:mx-0 ow-rounded-small overflow-hidden"
                style={{
                    boxShadow:
